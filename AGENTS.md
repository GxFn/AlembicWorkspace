...
> Wakeflow is installed as a Codex plugin for this workspace. Use Wakeflow MCP tools for setup, status, state roots, delivery, review, archive, and verification; local Wakeflow runtime scripts live in the installed plugin, not in this workspace root.
...
Operational details live in `installed Wakeflow skill wakeflow-governance/`,
