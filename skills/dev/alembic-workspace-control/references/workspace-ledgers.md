...
Use this reference when creating, moving, syncing, or archiving AlembicWorkspace control documents, status mirrors, indexes, templates, Design handoff ledgers, test exchange entries, or workspace skill assets.
...
- `docs/workspace/current/alembic-test-exchange.md` is the total-control exchange point for real `AlembicTest` handoffs and evidence.
- `AlembicDesign/docs/current/` holds Design-side drafts, signals, and handoff boards. Total control receives them, then decides whether to write workspace formal ledgers.
...
- Real test project docs remain project docs; Alembic validation plans, scans, acceptance, and reproduction records should be kept in workspace control docs or `AlembicTest/docs/`.

## Workspace Git Governance

- AlembicWorkspace may track workspace-owned documentation, scripts, templates, and skill assets only.
