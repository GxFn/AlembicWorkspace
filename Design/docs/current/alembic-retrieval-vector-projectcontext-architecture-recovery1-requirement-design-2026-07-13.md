...
- Design Key: `alembic-retrieval-vector-projectcontext-architecture-recovery1-2026-07-13`
- Date: 2026-07-13
- Status: confirmed; ready-for-controller-intake
- Owner Window: Design
- Receiving Window: AlembicWorkspace controller
- Original Plan: `Design/docs/current/alembic-retrieval-vector-projectcontext-architecture-recovery1-original-plan-2026-07-13.md`

## Recovery Provenance

Recovery key only. Except for the Design Key, recovery filenames/cross-document links, and this note, the product goal, confirmed decisions, completion definition, Core→Plugin order, no-Test decision, and non-goals are byte-for-byte copied and semantically unchanged from the confirmed design `alembic-retrieval-vector-projectcontext-architecture-2026-07-13`. No new question or additional scope is introduced.
...
- `Design/docs/current/alembic-retrieval-vector-projectcontext-architecture-recovery1-original-plan-2026-07-13.md`
