...
| `AlembicTest` | 测试单执行、真实项目复现、冷启动监控、回归、restart/monitor/probe 脚本、测试报告和证据整理。 | 产品实现、源码迁移、发布物构建、真实项目业务改造、默认运行时清理逻辑。 | `docs/workspace/current/test-exchange.md` 测试单和 `AlembicTest/docs/` 报告。 | [AlembicTest GFBD-1 evidence](../../AlembicTest/docs/global-function-boundary-evidence-test-2026-05-22.md) |
