...
- Stage 0 只读 inventory 已完成：[plugin-coldstart-rescan-test-optimization-stage-0-inventory-2026-05-31.md](../../../../../codex-control-workspace/.workspace-active/workspace/current/plugin-coldstart-rescan-test-optimization-stage-0-inventory-2026-05-31.md)。
...
- 2026-05-31：总控已直接发送 `PLUGIN-COLDSTART-RESCAN-TEST-OPTIMIZATION-STAGE-1-2` 给既有 AlembicPlugin 线程；thread id 仅保存在 `.workspace-local` 本地 registry，计划正文不记录；当前等待 AlembicPlugin 回填提交、验证和 evidence checker 证据。
