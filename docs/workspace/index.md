...
| `AlembicAgent` | 待启动 | 新增 publish staging manifest / pack preview；dev manifest 保留 `file:../AlembicCore`，staging manifest 使用 registry `@alembic/core` 并记录 Core source commit。 | 新建 | `docs/AlembicAgent/alembic-agent-publish-staging-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicAgent” |
