...
| `AlembicCore` | 待启动 | 补齐 `@alembic/core` release workflow / playbook，使 Core 作为下游 registry dependency 的源头。 | 新建 | `docs/AlembicCore/alembic-core-release-workflow-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicCore” |
