...
| 类型 | 文档 | 状态 | 说明 |
| --- | --- | --- | --- |
| Release closeout 验收与 publish staging Wave 2 | [alembic-release-portable-snapshot-closeout-acceptance-publish-staging-wave-2-plan-2026-05-18.md](alembic-release-portable-snapshot-closeout-acceptance-publish-staging-wave-2-plan-2026-05-18.md) | 执行中 | 当前新入口：Release / portable snapshot closeout 已验收通过；按用户纠正，`alembic-ai` 由 Alembic 主仓库发布，AlembicPlugin 只产出 Codex 插件产物 / portable runtime artifact，不走 npm registry 包发布；AlembicCore release workflow 和 AlembicAgent publish staging 已完成。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `Alembic` | 待启动 | 作为 `alembic-ai` owner，新增/调整 publish staging manifest / pack preview；dev manifest 继续 local-source-first，staging manifest 使用 registry `@alembic/core` 与 `@alembic/agent`。 | 新建 | `docs/Alembic/alembic-ai-publish-staging-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / Alembic” |
...
| `AlembicPlugin` | 待启动 | 退出 root npm registry publish 链路，改为只产出 Codex 插件产物和 portable runtime artifact；embedded runtime 继续 `file:vendor/AlembicCore`。 | 新建 | `docs/AlembicPlugin/alembic-plugin-artifact-release-no-npm-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicPlugin” |
