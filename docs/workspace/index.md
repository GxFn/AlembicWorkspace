...
| 类型 | 文档 | 状态 | 说明 |
| --- | --- | --- | --- |
| 当前计划 | [alembic-plugin-service-request-boundary-workspace-plan-2026-05-21.md](alembic-plugin-service-request-boundary-workspace-plan-2026-05-21.md) | AlembicTest 待启动 | 用户确认 Alembic 应作为常驻服务由 Plugin 按需请求，不做 MCP tool ownership bridge；`AlembicPlugin` service request 边界已通过总控验收，当前发送 `AlembicTest` 复测。 |
| 当前状态 | [workspace-current-status.md](workspace-current-status.md) | AlembicTest 待启动 | `Alembic` bridge 已作为兼容能力完成；`AlembicPlugin` service request 边界已验收，当前创建 Test-2026-05-21-02 等待 `AlembicTest` 领取。 |
| 当前测试结果 | [alembic-test-exchange.md](alembic-test-exchange.md) | 待启动 | Test-2026-05-21-02：复测 BiliDili prime shout、serviceBoundary、Codex 知识呐喊和 BiliDili git 干净状态。 |
...
| AlembicTest 测试交流文档 | [alembic-test-exchange.md](alembic-test-exchange.md) | 待启动 | Test-2026-05-21-02 已创建，等待 `AlembicTest` 领取执行。 |
...
| `AlembicTest`<br>待启动 | 领取 Test-2026-05-21-02，复测 BiliDili prime shout、serviceBoundary、Codex 知识呐喊和 BiliDili git 干净状态。 |
