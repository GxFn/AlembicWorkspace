...
| 接口边界 Wave 2C 验收总结 | [alembic-core-agent-interface-boundary-wave-2c-acceptance-summary-2026-05-18.md](alembic-core-agent-interface-boundary-wave-2c-acceptance-summary-2026-05-18.md) | 已完成 | 优化后的 Wave 2C 已总控验收通过；不重复发送已完成的本地源码引入任务，不做例行 vendor / 远程指针同步。 |
| 接口边界 Wave 2C 优化计划 | [alembic-core-agent-interface-boundary-wave-2c-optimized-plan-2026-05-18.md](alembic-core-agent-interface-boundary-wave-2c-optimized-plan-2026-05-18.md) | 已完成 | 回到上一轮 Wave 2C 后的新入口：总控已复核 Alembic / AlembicPlugin / AlembicAgent 的 Core / Agent interface boundary 消费证据。 |
...
| 本地源码引入统一验收总结 | [alembic-local-source-import-unification-acceptance-summary-2026-05-18.md](alembic-local-source-import-unification-acceptance-summary-2026-05-18.md) | 已完成 | Alembic / AlembicPlugin / AlembicAgent 引入口径统一已通过总控验收；当前无需要发送的执行提示词。 |
| 引入统一总控 | [alembic-local-source-import-unification-workspace-plan-2026-05-18.md](alembic-local-source-import-unification-workspace-plan-2026-05-18.md) | 已完成 | 已暂停旧 Wave 2C 一轮并完成 Alembic / AlembicPlugin / AlembicAgent 本地源码引入口径统一；BiliDili 默认不进入日常开发流程。 |
...
| 接口边界 Wave 2B 验收与旧 Wave 2C 分派 | [alembic-core-agent-interface-boundary-wave-2b-acceptance-wave-2c-plan-2026-05-18.md](alembic-core-agent-interface-boundary-wave-2b-acceptance-wave-2c-plan-2026-05-18.md) | 已优化 | AlembicAgent Wave 2B 已总控验收通过；旧 Wave 2C 分派已由优化计划接管，暂不直接派发。 |
| 接口边界 Wave 2A 验收与 Wave 2B 分派 | [alembic-core-agent-interface-boundary-wave-2a-acceptance-wave-2b-plan-2026-05-18.md](alembic-core-agent-interface-boundary-wave-2a-acceptance-wave-2b-plan-2026-05-18.md) | 已完成 | AlembicAgent 已完成 Wave 2B 并提交 `1af571674d3eb123e5aad695cb9a02fc69ce37d6`；后续入口改为 Wave 2B 验收与 Wave 2C 分派文档。 |
...
| 接口边界 Wave 1 验收与 Wave 2A 分派 | [alembic-core-agent-interface-boundary-wave-1-acceptance-wave-2-plan-2026-05-18.md](alembic-core-agent-interface-boundary-wave-1-acceptance-wave-2-plan-2026-05-18.md) | 已完成 | Wave 2A AlembicCore 已完成并提交 `b904b66907e16e61f29a6dc0eeedc59231ddfb53`；后续入口改为 Wave 2A 验收与 Wave 2B 分派文档。 |
...
| 接口边界 Wave 1 执行总控 | [alembic-core-agent-interface-boundary-workspace-plan-2026-05-18.md](alembic-core-agent-interface-boundary-workspace-plan-2026-05-18.md) | 已完成 | Core/Agent/Alembic/Plugin Wave 1 均已完成；Agent public API boundary 和 Core consumer allowlist 已建立，Core 产出 Phase 10 facade 判断。 |
...
| 当前冗余删除总控 | [alembic-redundant-systems-removal-workspace-plan-2026-05-18.md](alembic-redundant-systems-removal-workspace-plan-2026-05-18.md) | 已完成 | Feishu/Lark remote 遗留截屏连带能力、推荐系统和 ReverseGuard 已完成删除；Wave 1 源头删除、Wave 2 vendor/runtime/package/channel 收口和最终负向扫描均已验收通过。 |
| Wave 1 验收与 Wave 2 分派 | [alembic-redundant-systems-wave-1-acceptance-wave-2-plan-2026-05-18.md](alembic-redundant-systems-wave-1-acceptance-wave-2-plan-2026-05-18.md) | 已完成 | Alembic / AlembicCore / AlembicDashboard / AlembicAgent Wave 1 验收通过；Alembic 与 AlembicPlugin Wave 2 已完成并通过最终总控验收。 |
...
| 上一轮清理总控 | [alembic-feishu-remote-removal-plan-2026-05-17.md](alembic-feishu-remote-removal-plan-2026-05-17.md) | 已完成 | Feishu/Lark remote 完整删除计划已总控验收通过；主运行时、Agent contract、Core schema、Dashboard 文案、vendor/runtime、Codex plugin runtime/tarball 和 channel/package-facing 文档均已收口。 |
...
| 当前验收与下一步总控 | [alembic-agent-cutover-final-integration-readiness-wave-6-plan-2026-05-17.md](alembic-agent-cutover-final-integration-readiness-wave-6-plan-2026-05-17.md) | 已完成 | Wave 6 最终跨仓库集成 / release readiness / 需要宿主权限的 terminal smoke；五个窗口均已完成，总控最终验收通过。 |
...
| Wave 5 terminal/sandbox 边界总控 | [alembic-terminal-sandbox-agent-tool-boundary-wave-5-plan-2026-05-17.md](alembic-terminal-sandbox-agent-tool-boundary-wave-5-plan-2026-05-17.md) | 已完成 | Wave 5 已总控验收通过；AlembicAgent 已补 terminal Agent tool contract，Alembic 已消费 contract 并删除本地 portable duplicate，只保留真实 host executor/sandbox bridge；提交 `6598857fddd2f94d3d5c05ec5c1836879d1fc657`。 |
...
| Wave 2 验收与下一步总控 | [alembic-agent-extraction-boundary-wave-2-acceptance-next-plan-2026-05-17.md](alembic-agent-extraction-boundary-wave-2-acceptance-next-plan-2026-05-17.md) | 已完成 | 四仓库 wave 2 验收结论、验证结果、Tool V2 消费主线、Plugin/Dashboard live 联动和 release readiness 分派表。 |
| Alembic Tool V2 contract consumption | [alembic-tool-v2-contract-consumption-2026-05-17.md](alembic-tool-v2-contract-consumption-2026-05-17.md) | 已完成 | Alembic 已消费 `@alembic/agent/tools/v2` generic contract，仅保留 host-owned `ToolContextFactory` bridge；提交 `14faa15`。 |
| AlembicPlugin release readiness | [alembic-plugin-release-readiness-2026-05-17.md](alembic-plugin-release-readiness-2026-05-17.md) | 已完成 | Plugin release gate、Codex channel verify、完整 smoke 和 daemon/dashboard smoke 均已通过；提交 `e7840d0`。 |
...
| 上一轮验收与下一步总控 | [alembic-agent-extraction-boundary-acceptance-next-plan-2026-05-17.md](alembic-agent-extraction-boundary-acceptance-next-plan-2026-05-17.md) | 已完成 | AlembicAgent / Alembic / AlembicPlugin / AlembicDashboard 上一波任务已验收；Plugin full smoke 阻塞已解除。 |
| AlembicPlugin npx runtime packaging 修复 | [alembic-plugin-npx-runtime-packaging-fix-2026-05-17.md](alembic-plugin-npx-runtime-packaging-fix-2026-05-17.md) | 已完成 | Plugin embedded runtime 已改为 vendor Core + bundled production dependencies，完整 `npm run smoke:codex-plugin` 通过。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `Alembic` | 已完成 | 已作为 `alembic-ai` owner 新增 publish staging manifest / pack preview；dev manifest 继续 local-source-first，staging manifest 使用 registry `@alembic/core@0.1.0` 与 `@alembic/agent@0.1.0`，release workflow 发布 staging package。 | 已新建 | `docs/Alembic/alembic-ai-publish-staging-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派”；Alembic AI publish staging Wave 2 执行记录 | Release closeout 验收与 publish staging Wave 2“回填区 / Alembic” |
| `AlembicCore` | 已完成 | 已补齐 `@alembic/core` release workflow / playbook：manual dry-run release staging、`v*` tag publish、pack preview artifact、npm provenance publish 和 release playbook；提交 `9174c5173a7313b916b89b7c605ea2afdd874269`。 | 已新建 | `docs/AlembicCore/alembic-core-release-workflow-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派”；AlembicCore release workflow Wave 2 执行记录 | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicCore” |
| `AlembicAgent` | 已完成 | 已新增 publish staging manifest / pack preview；dev manifest 保留 `file:../AlembicCore`，staging manifest 使用 registry `@alembic/core@0.1.0` 并记录 Core source commit；提交 `f9d020f9ebaf95499bbd6e9afbdecafa0615a865`。 | 已新建 | `docs/AlembicAgent/alembic-agent-publish-staging-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派”；AlembicAgent publish staging Wave 2 执行记录 | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicAgent” |
| `AlembicDashboard` | 观察中 | 本轮不改 Dashboard 源码，只作为 Alembic / AlembicPlugin release workflow sibling build source。 | 无需新建 | 无 | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicDashboard” |
| `AlembicPlugin` | 已完成 | 已退出 root npm registry publish 链路，只产出 Codex 插件产物和 portable runtime artifact；embedded runtime 继续 `file:vendor/AlembicCore` 并记录 source metadata；提交 `6883affe2668c33627aa5c9529e12096735f3abe`，子仓库提交 `dbbeb3a2da170256ed09b69b82771c6db1c7acf5`。 | 已新建 | `docs/AlembicPlugin/alembic-plugin-artifact-release-no-npm-wave-2-2026-05-18.md` | Release closeout 验收与 publish staging Wave 2“窗口分派”；AlembicPlugin artifact release no npm Wave 2 执行记录 | Release closeout 验收与 publish staging Wave 2“回填区 / AlembicPlugin” |
| `BiliDili` | 无任务 | 当前是 release staging / package ownership，不涉及真实 iOS/Swift 测试项目。 | 无需新建 | 无 | Release closeout 验收与 publish staging Wave 2“窗口分派” | Release closeout 验收与 publish staging Wave 2“回填区 / BiliDili” |
