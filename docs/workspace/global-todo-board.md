...
| GTODO-2026-05-21-009 | 待启动 | 可见语义修正 | P0 | `AlembicPlugin` | 收紧 prime receipt shout 的说话者主语：开发者可见呐喊应由 Codex / 我来声明接收到哪些知识，不要默认生成 “Alembic prime 已接收” 这类工具名作主语的表达。 | 不新增 AlembicTest 复测；只影响 Plugin 派发 | 用户截图反馈；用户确认不走测试；当前计划 SHOUT-7。 | `AlembicPlugin` | [prime-immediate-receipt-shout-workspace-plan-2026-05-21.md](prime-immediate-receipt-shout-workspace-plan-2026-05-21.md) |
