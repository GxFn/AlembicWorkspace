...
| Topic | 说明 |
| --- | --- |
| [agent-efficiency-observability](agent-efficiency-observability/) | 冷启动效率、job 状态和 observability 历史计划。 |
| [agent-evidence-recording-phase-chain](agent-evidence-recording-phase-chain/) | Agent evidence recording / phase chain 历史测试线计划。 |
...
| [github-actions-failure-recovery](github-actions-failure-recovery/) | GitHub Actions failure recovery 历史计划。 |
| [global-function-boundary-design](global-function-boundary-design/) | 全局职责功能划分历史证据和分派记录。 |
...
| [redundant-systems-removal](redundant-systems-removal/) | 飞书截屏连带、推荐系统、ReverseGuard 等冗余清理。 |
