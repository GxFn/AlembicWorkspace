...
发送给：无
总控定位：本文件是 AlembicWorkspace 当前总控计划；只承载迁移目标、阶段边界、窗口分派、TODO 归口、测试交接和验收回填，不承载产品实现。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TODO-1 | 观察中 |  | P2 | Workspace |  | 否 |  | AlembicWorkspace |

## 空闲窗口调度

| 窗口 | 调度 | 是否发送 | 原因 |
| --- | --- | --- | --- |
| `Alembic` | 观察 / 无任务 / 主线任务 | 否 |  |
| `AlembicCore` | 观察 / 无任务 / 主线任务 | 否 |  |
| `AlembicAgent` | 观察 / 无任务 / 主线任务 | 否 |  |
| `AlembicDashboard` | 观察 / 无任务 / 主线任务 | 否 |  |
| `AlembicPlugin` | 观察 / 无任务 / 主线任务 | 否 |  |
| `AlembicTest` | 阻塞 / 待启动 / 无任务 | 否 |  |
...
| `AlembicCore`<br>无任务 |  |
| `AlembicAgent`<br>无任务 |  |
| `AlembicDashboard`<br>无任务 |  |
| `AlembicPlugin`<br>无任务 |  |
| `AlembicTest`<br>无任务 |  |
