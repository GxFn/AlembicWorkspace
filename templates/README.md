...
- [phased-migration-command-template.md](phased-migration-command-template.md)：分阶段迁移 / 大型收口指挥短模板；完整迁移经验、扫描命令和反模式见 `skills/dev/alembic-workspace-control/references/phased-migration.md`。
