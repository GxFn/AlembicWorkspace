...
This is the documentation area for the built-in Wakeflow Test surface.

Use this directory for long-lived test plans, reproduction notes, smoke
reports, monitoring observations, and validation evidence that belong to Test.
Raw local evidence belongs under ignored `tmp/`; summarize durable conclusions
in `docs/`.
