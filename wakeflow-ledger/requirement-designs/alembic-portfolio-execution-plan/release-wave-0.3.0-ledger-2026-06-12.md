...
| 3 | Pinned npm runtime publication (live-proven E404 cold-start blocker; two thin host shells reference it). NAMING RULED 2026-06-13: package renames to **@gxfn/alembic-runtime** BEFORE first publication (zero published consumers — clean window); plugin distribution name → **alembic** (alembic@gxfn) per user ruling + plugin-naming-ruling-2026-06-13.md | originally STAGED by P3 t7 (206-file tgz verified under the old name); N1 naming wave RESTAGES under @gxfn/alembic-runtime and records the refreshed exact publish command here | RENAME IN FLIGHT (N1) → then STAGED — user publish trigger |
