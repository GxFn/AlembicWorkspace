...
const baseUrl = process.argv[2] || "http://127.0.0.1:64621";
const outDir =
  process.argv[3] ||
  "/Users/gaoxuefeng/Documents/AlembicWorkspace/.wakeflow-active/current/alembic-panorama-rebuild-2026-07-03/evidence/p4-final-panorama-real-dashboard-scope-rerun-after-embedding-config-repair-t1";
